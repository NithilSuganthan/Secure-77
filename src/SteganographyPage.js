    ...
    <div className="app-container steganography-page">
      <div className="app-header">
        ...
        <p className="app-subtitle">
          Military-grade data hiding with AES-256 encryption and invisible steganography
        </p>
      ...
      <div className="security-features">
        ...
        <div className="security-feature">
          ...
          <span className="feature-text">Invisible Data Hiding</span>
        </div>
        <div className="security-feature">
          <svg className="feature-icon" viewBox="0 0 24 24">
        ...
        <div className="security-feature">
          ...
          <span className="feature-text">Military-Grade Security</span>
        </div>
      </div>
